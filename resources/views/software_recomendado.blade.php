            ...
            <div class="col-md-10 col-lg-10 wow fadeInUp">
                <div class="row row-30">
                    <div class="col-md-10 col-lg-10 wow fadeInUp">
                        ...
                        <a class="button button-primary" href="/software">Volver al listado general</a>
                    </div>
                ...
                <div class="row row-30">
                    <div class="container">
                        <h3>Listado Priorizado de Alternativas de Software Libre</h3>
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @forelse($software as $alternativa)
                                    <tr>
                                        <td>{{ $alternativa->recomendacion }}</td>
                                ...
                                @empty
                                    <tr><td>Aún no existe software recomendado</td></tr>
                                @endforelse
                            </tbody>
                        </table>
